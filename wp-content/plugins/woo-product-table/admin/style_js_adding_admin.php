 ...
 */
function wptf_admin_js_fast_load(){
    wp_enqueue_script( 'wptf-admin-js', WPT_Product_Table::getPath( 'BASE_URL' ) . 'js/admin.js', array( 'jquery' ), '1.0.0', true );
}
add_action( 'admin_enqueue_scripts', 'wptf_admin_js_fast_load', 1 );
