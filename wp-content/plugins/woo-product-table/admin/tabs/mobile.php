...
<div class="wptf_column">
    ...
    <select name="mobile[mobile_responsive]" data-name='mobile_responsive' id="wptf_table_mobile_responsive" class="wptf_fullwidth wptf_data_filed_atts" >
        ...
        <option value="no_responsive" <?php echo isset( $meta_mobile['mobile_responsive'] ) && $meta_mobile['mobile_responsive'] == 'no_responsive' ? 'selected' : ''; ?>><?php esc_html_e( 'No Responsive', 'wptf_pro' ); ?></option>
    </select>
