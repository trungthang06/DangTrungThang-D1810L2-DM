...
$additional_collumn = array_diff(array_keys($columns_array), array_keys( WPT_Product_Table::$columns_array ));
...
<ul id="wptf_column_sortable">
    ...
    <li class="wptf_sortable_peritem <?php echo esc_attr( $enabled_class ); ?> column_keyword_<?php echo esc_attr( $keyword ); ?> <?php echo $only_premium_class; ?>">
        ...
        <div class="wptf_shortable_data">
            <input placeholder="<?php echo $keyword; ?>" name="column_array[<?php echo $keyword; ?>]"  data-column_title="<?php echo esc_attr__( $title,'wptf_pro' ); ?>" data-keyword="<?php echo esc_attr( $keyword ); ?>" class="colum_data_input <?php echo esc_attr( $keyword ); ?>" type="text" value="<?php echo $title; ?>" <?php echo $readOnly; ?>>
            ...
            <?php } ?>
             <?php
                ...
                if( in_array($keyword,$additional_collumn) ){
                    echo "<span class='wptf_column_cross'>X</span>";
                }
            ?>
        </div>
    ...
    <div id="tax_cf_manager">
        <div class="tax_cf_manager_column tax_cf_manager_choose_column">
            ...
            <select class="taxt_cf_type">
                <option value="cf_"><?php esc_html_e( 'Custom Field', 'wptf_pro' );?></option>
