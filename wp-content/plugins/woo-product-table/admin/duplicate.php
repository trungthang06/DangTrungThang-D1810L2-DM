...
function wptf_duplicate_as_draft(){
	global $wpdb;
...
add_action( 'admin_action_wpt_duplicate_as_draft', 'wptf_duplicate_as_draft' );
 
/*
 * Add the duplicate link to action list for post_row_actions
 */
function wptf_duplicate_link( $actions, $post ) {
...
add_filter( 'post_row_actions', 'wptf_duplicate_link', 10, 2 );
