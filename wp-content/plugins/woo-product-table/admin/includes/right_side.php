<div class="wptf_rightside">
    ...
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="need_help_wrapper">
            <h1>Need Help?</h1>
            <a style="display: block;text-align: left;" target="_blank" href="https://wordpress.org/support/plugin/woo-product-table/#no-topic-0">
                <img style="max-width: 100px" src="<?php echo WPT_FREE_BASE_URL; ?>images/customer_support.png">
    ...
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="need_help_wrapper">
            <h3 style="margin:4px 0px"><a target="_blank" href="https://codecanyon.net/item/woo-product-table-pro/20676867">Get The Pro Version</a></h3>
            <a target="_blank" href="https://codecanyon.net/item/woo-product-table-pro/20676867"><img width=100%; src="<?php echo WPT_FREE_BASE_URL; ?>images/wpt-pro.png"</a>
        </div>
    </div>
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
